...
export default async function TermsAndCondition() {
  return (
    <main className="flex w-full flex-col flex-wrap h-auto gap-1   bg-white px-5 md:px-10 my-10">
      ...
      <h3 className="text-[19px] font-semibold mt-4">Interpretation</h3>
      <p>
      ...
      <h3 className="text-[19px] font-semibold mt-4">Definitions</h3>
      ...
      <h2 className="text-[20px] font-bold mt-5">Acknowledgment</h2>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Termination</h2>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Limitation of Liability</h2>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Governing Law</h2>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Severability and Waiver</h2>
      <h3 className="mt-1 text-[18px] font-semibold ">Severability</h3>
      <p>
      ...
      <h3 className="mt-1 text-[18px] font-semibold ">Waiver</h3>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Translation Interpretation</h2>
      <p>
