...
export default async function TermsAndCondition({
  ...
  const definitions = [
    ...
    },
    {
      title: "Company",
      description:
        '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Inshorten.',
    },
    {
      title: "Device",
      description:
    ...
    },
    {
      title: "Website",
      description:
        "refers to Inshorten, accessible from https://inshorten.com.",
    },
    {
      title: "You",
      description:
  ...
  return (
    <main className="flex w-full flex-col flex-wrap h-auto gap-1   bg-white px-5 md:px-10 my-10">
        ...
        {definitions.map((definition, index) => (
          <li key={index}>
            <p>
              ...
              {definition.description.includes("https") ? (
                <a
                ...
                >
                  {definition.description.match(/https:\/\/[^ ]+/)}
                </a>
              ) : (
      ...
      <h2 className="text-[17px] font-semibold">Governing Law</h2>
      <p>
      ...
      <h2 className="text-[17px] font-semibold">Disputes Resolution</h2>
      <p>
      ...
      <h3 className=" text-[17px] font-semibold">Severability</h3>
      <p>
      ...
      <h3 className=" text-[17px] font-semibold">Waiver</h3>
      <p>
