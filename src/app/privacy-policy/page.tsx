...
export default async function PrivacyPolicy({
  ...
  const terms = [
    ...
    {
      title: "Company",
      description: "refers to Inshorten.",
    },
    {
      title: "Cookies",
      description:
  ...
  return (
    <main className="flex w-full flex-col flex-wrap h-auto bg-white px-5 md:px-10 my-10 ">
      ...
      <h3 className="text-[18px] font-semibold mt-3 ">
        Types of Data Collected
      </h3>
      <h4 className="mt-1">Personal Data</h4>
      <p>
      ...
      <ul>
        <li>
          <p className="font-semibold mt-3 text-[18px]">Email address</p>
        </li>
        <li className="mt-1">
          <p>Usage Data</p>
        </li>
      ...
      <h3 className="text-[20px] font-semibold mt-6 text-[#0B80E1]">
      ...
      <h2 className="text-[20px] font-semibold mt-5 text-[#0B80E1]">
        Children&apos;s Privacy
      </h2>
      <p>
