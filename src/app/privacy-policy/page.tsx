...
export default async function PrivacyPolicy() {
  return (
    <main className="flex w-full flex-col flex-wrap h-auto bg-white px-5 md:px-10 my-10 ">
      ...
      <h3 className="text-[19px] font-bold mt-2 ">Interpretation</h3>
      <p>
      ...
      <h3 className="text-[19px] font-bold mt-2 ">Definitions</h3>
      ...
      <h4 className="mt-2 text-[18px] font-semibold ">Personal Data</h4>
      <p>
      ...
      <ul>
        <li className="mt-2 text-[18px] font-semibold ">
          <p>Email address</p>
        </li>
      </ul>
      <h4 className="mt-2 text-[18px] font-semibold ">Usage Data</h4>
      ...
      <ul>
        <li>
          <p>
            <strong className="mt-2 text-[18px] font-semibold ">
      ...
      <h3 className="text-[20px] font-bold mt-4">Use of Your Personal Data</h3>
      ...
      <h3 className="text-[20px] font-bold mt-5 ">
        Disclosure of Your Personal Data
      </h3>
      <h4 className="text-[18px] font-semibold mt-4 ">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-[18px] font-semibold mt-4 ">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-[18px] font-semibold mt-4 ">
      ...
      <h2 className="text-[20px] font-bold mt-5">Children's Privacy</h2>
      <p>
      ...
      <h2 className="text-[20px] font-bold mt-5">Links to Other Websites</h2>
      <p>
